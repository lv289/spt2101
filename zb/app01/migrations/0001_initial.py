# Generated by Django 3.0.8 on 2021-06-15 12:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='CheckInfo',
            fields=[
                ('check_id', models.CharField(max_length=15, primary_key=True, serialize=False)),
                ('time', models.CharField(max_length=50)),
                ('status', models.CharField(max_length=50)),
                ('buf1', models.CharField(max_length=50, null=True)),
                ('buf2', models.CharField(max_length=50, null=True)),
                ('sid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.StudentInfo')),
            ],
        ),
        migrations.CreateModel(
            name='UserInfo',
